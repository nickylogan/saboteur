...
//        System.out.println("Inside heuChecker");
        ...
        for(Move trgtMove : targets) {
            ...
            if(isMiner) {
                ...
                bmove += (path.topSide().val()) * 1.8f;
                bmove += (path.rightSide().val()) * 2.0f;
                bmove += (path.bottomSide().val()) * 1.8f;

                //      Card has RightPath     AND    Card has BottomPath AND  Card has TopPath
                if(path.sides()[1].val() == 1 && path.sides()[2].val() == 1 && path.sides()[0].val() == 1) {
                    bmove = bmove + 0.3f*(2);
//                System.out.println("1 Met, bmove="+bmove);
                }
...
//                System.out.println("3 Met, bmove="+bmove);
                ...
                bmove -= (path.topSide().val()) * 4.0f;
                bmove -= (path.rightSide().val()) * 100.0f;
                bmove -= (path.bottomSide().val()) * 4.0f;
...
//                System.out.println("1 Met, bmove="+bmove);
                ...
                if(goalData[0] == 1) {
                    bmove += Math.abs((4 - trgtMove.args()[1])/4*8.0f);
                } else if(goalData[1] == 1) {
                    bmove += Math.abs((2 -(Math.abs(trgtMove.args()[1]-2)))/2.0f * 8.0f);
                } else if(goalData[2] == 1) {
                    bmove += (trgtMove.args()[1])/4*8.0f;
                } else {
                    bmove += Math.abs((2 -(Math.abs(trgtMove.args()[1]-2)))/2.0f * 4.0f);
                }
...
//        System.out.println("Inside heuChecker");
            ...
            if(isMiner) {
                ...
                if(goalData[0] == 1) {
                    bmove += Math.abs((4 - target.args()[1])/4*8.0f);
                } else if(goalData[1] == 1) {
                    bmove += Math.abs((2 -(Math.abs(target.args()[1]-2)))/2.0f * 8.0f);
                } else if(goalData[2] == 1) {
                    bmove += (target.args()[1])/4*8.0f;
                } else {
                    bmove += Math.abs((2 -(Math.abs(target.args()[1]-2)))/2.0f * 4.0f);
                }
...
//                System.out.println("Heu Rockfall: "+heu);
    ...
    MoveHeu minHeu(ArrayList<MoveHeu> possibleMoves) {
        MoveHeu bestMove = new MoveHeu(MAX_VALUE);
