...
public class Player extends SelectableObject{
	...
	protected int role;
	protected int ttlBlockCart;
	protected int ttlBlockLight;
	protected int ttlBlockPickaxe;
	protected int statGoal1;
	protected int statGoal2;
	protected int statGoal3;	
	...
	public ArrayList<CardPlayable> getCards() {
		return cards;
	}

	public void setCards(ArrayList<CardPlayable> cards) {
		this.cards = cards;
	}
	...
	public String getGoals(){
		...
		return statGoal1+" "+statGoal2+" "+statGoal3;
	}
